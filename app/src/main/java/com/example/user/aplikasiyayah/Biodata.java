    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Biodata.this, Login.class);
                finish();
        ...
        if (ContextCompat.checkSelfPermission(Biodata.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
    ...
    public void UploadImageToServer(){
        ...
        class AsyncTaskUploadClass extends  AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute(){
                super.onPreExecute();
                progressDialog=ProgressDialog.show(Biodata.this,"Data sedang dikirim" ,"Please Wait",false,false);
            }
            @Override
            protected void  onPostExecute(String string1){
                super.onPostExecute(string1);
                progressDialog.dismiss();
                Toast.makeText(Biodata.this,string1,Toast.LENGTH_LONG).show();
                nim.setText("");
                nohp.setText("");
                imageName.setText("");
                tgl_result.setText("");
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults){
        ...
        if (requestCode == 5){
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED){
                ...
                Toast.makeText(Biodata.this, "Unable to use Camera..Please Allow us to use Camera", Toast.LENGTH_LONG).show();
